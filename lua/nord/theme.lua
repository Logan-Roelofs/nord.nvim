...
theme.loadEditor = function()
	...
	local editor = {
		NormalFloat = { fg = nord.nord4_gui, bg = nord.none }, -- normal text and background color
		FloatBorder = { fg = nord.nord4_gui, bg = nord.none }, -- normal text and background color
...
theme.loadPlugins = function()
	...
	local plugins = {
		...
		-- NeoTree
		NeoTreeTitleBar = { fg = nord.nord0_gui, bold = true,},
